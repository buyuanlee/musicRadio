{
    let view = {
        ...
        template: `
            ...
            <button class="uploadBtn" id="pickfiles">
                点击上传
            </button>
    ...
    let controller = {
        ...
        initQiniu() {
            ...
            var uploader = Qiniu.uploader({
                ...
                //uptoken : '1WabYXKTZj-8GQLq9Es4mQUnNl9DvFy2LVZ9FjNr:BXSiWsE4EXbhBV4j1HAMX6ANta0=:eyJzY29wZSI6Im15cmFkaW8iLCJkZWFkbGluZSI6MTU0MDI5MTI3Nn0=',
                // 若未指定uptoken_url,则必须指定 uptoken ,uptoken由其他程序生成
                // unique_names: true, // 默认 false，key为文件名。若开启该选项，SDK为自动生成上传成功后的key（文件名）。
                // save_key: true,   // 默认 false。若在服务端生成uptoken的上传策略中指定了 `sava_key`，则开启，SDK会忽略对key的处理
                domain: 'pfusdmv37.bkt.clouddn.com/',   //bucket 域名，下载资源时用到，**必需**
